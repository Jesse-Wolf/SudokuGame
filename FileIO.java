...
public class FileIO{
	 ...
	 *Set my fileName
	 *
	 *@param fileName is not already defined
	 */
	...
	/**
	 *To get fileName for use in Constructor
	 *
	...
	/**
	 *To get currentUser for use in Player class
	 *
	...
	/**
	 *To print all my arrays back into my file.
	 *
	 */
	public void saveToFile(){
		...
		for(int a=0;a<userName.length;a++){
			...
			outputStream.println();
			  ...
			  //System.out.print("My lineCount = " +lineCount);
		outputStream.close();
	}	
